...
<?php
	echo "<?php echo \$this->Form->submit(__('Submit'),array('class'=>'btn btn-primary','div'=>false));?>\n";
	echo "<?php echo \$this->Html->link(__('Cancel'),array('controller' => '{$details['controller']}', 'action' => 'index'),array('class'=>'btn btn-cancel'));?>\n";
?>
		</div>
		</fieldset>
<?php
