...
foreach ($relations as $alias => $details):
	...
	<div class="row">
		<div class="related span10 offset2">
			...
			<?php echo "<?php echo \$this->Html->link(__('New " . Inflector::humanize(Inflector::underscore($alias)) . "'), array('controller' => '{$details['controller']}', 'action' => 'add'), array('class'=>'btn btn-mini'));?>"; ?>
			</div>
	<?php echo "<?php if (!empty(\${$singularVar}['{$alias}'])):?>\n"; ?>
			<table class="table">
				<tr>
